...
df = df.iloc[210:510, :].reset_index(drop=True)
...
plt.legend()
plt.savefig("Plots (400-700 nm)/standard_sunset_yellow_and_tartarazine.png")
plt.clf()
...
for i in range(1, len(df.columns)):
    ...
    plt.legend()
    plt.savefig(f'Plots (400-700 nm)/{df.columns[i]}.png')
    plt.clf()
...
df2 = df2.iloc[210:510, :].reset_index(drop=True)
...
plt.legend()
plt.savefig("Plots (400-700 nm)/standard_sunset_yellow.png")
plt.clf()
...
df3 = df3.iloc[210:510, :].reset_index(drop=True)
...
plt.legend()
plt.savefig("Plots (400-700 nm)/standard_tartarazine_at_different_ppm.png")
plt.clf()
